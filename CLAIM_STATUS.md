...
- Universal Capacity Law: sustained high flow against slow-relaxing constraint
  can produce nonlinear overload.
- Universal Memory Law: unresolved prior load can persist as `M_s`, making later
  stress harder to clear.
- Cross-Domain Isomorphism: different domains can share a flow-constraint-memory
  form without being the same physical system.
